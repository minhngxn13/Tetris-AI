...
def get_args():
    ...
    parser.add_argument("--saved_path", type=str, default="ReinforcementLearning/trained_models")
    parser.add_argument("--output", type=str, default="ReinforcementLearning/output.mp4")
